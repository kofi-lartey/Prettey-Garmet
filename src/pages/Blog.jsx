...
const Blog = () => {
    const upcomingPosts = [
        ...
        {
            title: "Nail Art Ideas for Every Occasion",
            category: "Nails",
            date: "Coming Soon",
            image: "https://images.unsplash.com/photo-1604654894610-df63bc536371?w=800&q=80"
        },
        {
            title: "Preparing Your Skin for Your Wedding Day",
            category: "Skincare",
            date: "Coming Soon",
            image: "https://images.unsplash.com/photo-1512496015851-a90fb38ba796?w=800&q=80"
        },
        {
            title: "Quick Everyday Makeup Looks for Busy Professionals",
            category: "Makeup",
            date: "Coming Soon",
                ...
                <div className="container-custom">
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-lg max-w-2xl mx-auto">
                            Tips, trends, and tutorials coming soon
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {upcomingPosts.map((post, index) => (
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <h3 className="font-playfair text-xl text-gray-900 mb-3 line-clamp-2">
                                        {post.title}
                                    </h3>
                ...
                <div className="container-custom">
                    ...
                    >
                        ...
                        <p className="text-white/70 mb-8 max-w-xl mx-auto">
                            Subscribe to our newsletter and be the first to know when we launch our blog!
                        </p>
